...
CREATE OR REPLACE VIEW finalBK.ct_top_customers_by_spend AS
SELECT 
    c.full_name,
...
CREATE OR REPLACE VIEW finalBK.ct_top_customers_by_items AS
SELECT 
    c.full_name,
...
CREATE OR REPLACE VIEW finalBK.ct_top_customers_avg_spend AS
SELECT 
    c.full_name,
...
-- 4. Spend by family --
CREATE OR REPLACE VIEW finalBK.ct_customer_family_spend AS
SELECT 
    c.last_name,
...
CREATE OR REPLACE VIEW finalBK.ct_top_customers_by_orders AS
SELECT
	s.customer_id,
...
CREATE OR REPLACE VIEW finalBK.ct_customer_frequency_segment AS
SELECT
...
CREATE OR REPLACE VIEW finalBK.ct_top_customers_20pct_discount AS
SELECT
    c.full_name,
...
CREATE OR REPLACE VIEW finalBK.ct_top_customers_5pct_discount AS
SELECT
    c.full_name,
    COUNT(*) as dist_line_amount,
